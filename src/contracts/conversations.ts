...
import { conversationCollection, conversationQuerySchema } from "../lib/zod/converation.schemas.js";
...
const conversationContract = contract.router({
  ...
  archive: {
    method: "PUT",
    path: "/dashboards/:dashboardId/contacts/:phoneNumber/conversations/archive",
  ...
  unarchive: {
    method: "PUT",
    path: "/dashboards/:dashboardId/contacts/:phoneNumber/conversations/unarchive",
    pathParams: dashboardIdPhoneNumberParamsSchema,
    body: contract.noBody(),
    responses: {
      200: unknownResponseSchema,
