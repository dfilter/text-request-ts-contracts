...
import { createContactMessageSchema, messageCollectionSchema, messageSchema } from "../lib/zod/message.schemas.js";
...
export const commonContract = contract.router({
  messageeContact: {
    method: "POST",
    path: "/dashboards/:dashboardId/contacts/:phoneNumber/messages",
  ...
  dashboardMessageCollection: {
    method: "GET",
    path: "/dashboards/:dashboardId/messages",
