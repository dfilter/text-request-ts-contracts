...
export const dashboardIdFieldIdPathParamsSchema =
  dashboardIdPathParamsSchema.extend({ fieldId: z.string() });

export const dashboardIdPhoneNumberParamsSchema =
  dashboardIdPathParamsSchema.extend({ phoneNumber: z.string() });

export const dashboardIdTagIdPathParamSchema =
  dashboardIdPathParamsSchema.extend({ tagId: z.string() });
